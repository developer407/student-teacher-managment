...
export const PAY_TEACHER_AMOUNT_REQUEST = 'PAY_TEACHER_AMOUNT_REQUEST';
export const PAY_TEACHER_AMOUNT_SUCCESS = 'PAY_TEACHER_AMOUNT_SUCCESS';
export const PAY_TEACHER_AMOUNT_FAILURE = 'PAY_TEACHER_AMOUNT_FAILURE';